...
describe("WwwBroadwayWorldComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.broadwayworld.com/article/American-Theatre-Wing-Launches-Andrew-Lloyd-Webber-Training-Scholarships-20161013";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "BWW News Desk");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-10-13T15:35:00.000Z");
    });
