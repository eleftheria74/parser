...
describe("WwwMentalflossComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.mentalfloss.com/article/90140/its-not-too-late-holiday-shop-these-amazon-deals";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Smart Shopping Team");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-19T12:29:00.000Z");
    });
