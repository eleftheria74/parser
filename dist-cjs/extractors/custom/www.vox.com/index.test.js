...
describe("WwwVoxComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.vox.com/culture/2016/12/10/13898352/trump-twitter-harassment-policy-bannable";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Aja Romano");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-10T15:20:01.000Z");
    });
