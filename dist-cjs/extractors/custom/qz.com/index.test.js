...
describe("QzComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "https://qz.com/africa/1807355/nigerias-economy-has-best-quarterly-growth-since-recession/";
    ...
    it("returns the date_published", async () => {
      ...
      import_assert.default.equal(date_published, "2020-02-24T16:26:29.000Z");
    });
