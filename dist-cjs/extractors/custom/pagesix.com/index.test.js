...
describe("PagesixComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://pagesix.com/2016/12/19/sofia-vergara-and-nick-loebs-embryo-drama-taking-a-detour/";
    ...
    it("returns the title", async () => {
      ...
      import_assert.default.equal(
        title,
        "Sof\xEDa Vergara and Nick Loeb\u2019s embryo drama taking a detour"
      );
    });
    it("returns the author", async () => {
      const { author } = await result;
      import_assert.default.equal(author, "Oli Coleman");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-20T00:08:44.000Z");
    });
