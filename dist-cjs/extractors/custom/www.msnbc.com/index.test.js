...
describe("WwwMsnbcComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.msnbc.com/rachel-maddow-show/bizarre-election-ends-bizarre-electoral-college-tally";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Steve Benen");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-20T12:44:32.000Z");
    });
