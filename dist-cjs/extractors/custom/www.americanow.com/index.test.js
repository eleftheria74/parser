...
describe("WwwAmericanowComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.americanow.com/story/politics/2016/12/22/trump-names-kellyanne-conway-counselor-president";
    ...
    it("returns the title", async () => {
      ...
      import_assert.default.equal(title, "Kellyanne Conway Named Counselor To Trump");
    });
    it("returns the author", async () => {
      const { author } = await result;
      import_assert.default.equal(author, "Ray Brown");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-22T14:22:19.000Z");
    });
