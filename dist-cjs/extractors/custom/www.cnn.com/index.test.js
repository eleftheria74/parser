...
describe("WwwCnnComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.cnn.com/2016/11/29/politics/donald-trump-transition-presidency/index.html";
    ...
    it("returns the title", async () => {
      ...
      import_assert.default.equal(title, "Why Donald Trump won\u2019t change");
    });
    it("returns the author", async () => {
      const { author } = await result;
      import_assert.default.equal(author, "Stephen Collinson");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-11-29T10:39:35.000Z");
    });
