...
describe("WwwEngadgetComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "https://www.engadget.com/lyft-extends-free-scooter-rides-for-critical-workers-184144961.html";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Jon Fingas");
    });
    ...
    it("returns the content", async () => {
      ...
      const figure = $("figure");
      import_assert.default.equal(figure.length, 1);
      const p = $("p");
      import_assert.default.equal(p.length, 3);
    });
  });
});
