...
describe("AbcnewsGoComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://abcnews.go.com/US/hillary-clinton-putins-alleged-involvement-democratic-hack-stems/story?id=44233864&cid=clicksource_4380645_2_three_posts_vert_hed";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "JOSH HASKELL, DAVID CAPLAN and PATRICK REEVELL");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-16T21:19:00.000Z");
    });
