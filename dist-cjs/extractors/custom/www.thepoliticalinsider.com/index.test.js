...
describe("WwwThepoliticalinsiderComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.thepoliticalinsider.com/hillary-faithless-electors-more-than-trump/";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Editor");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-20T13:38:46.000Z");
    });
