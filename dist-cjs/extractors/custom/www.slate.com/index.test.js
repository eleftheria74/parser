...
describe("WwwSlateComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.slate.com/articles/news_and_politics/politics/2017/03/trumpcare_proves_that_trump_s_promise_to_take_care_of_rural_voters_was_always.html";
    ...
    it("returns the title", async () => {
      ...
      import_assert.default.equal(title, "Broken Pledge");
    });
    it("returns the author", async () => {
      const { author } = await result;
      import_assert.default.equal(author, "Jamelle Bouie");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2017-03-09T21:21:00.000Z");
    });
