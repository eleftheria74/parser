...
describe("WwwEonlineComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.eonline.com/news/814222/ryan-gosling-s-feelings-about-fatherhood-will-make-your-heart-sing";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Zach Johnson");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-12T14:00:00.000Z");
    });
