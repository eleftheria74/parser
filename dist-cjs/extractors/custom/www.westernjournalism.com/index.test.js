...
describe("WwwWesternjournalismComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.westernjournalism.com/berlin-terrorist-shot-dead-in-milan-by-rookie-police-officer/";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Jack Davis");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-23T14:18:32.000Z");
    });
    it("returns the dek", async () => {
      const { dek } = await result;
      import_assert.default.equal(dek, '"... awaiting someone.\u201D');
    });
