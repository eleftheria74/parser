...
describe("WwwRollingstoneComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.rollingstone.com/movies/features/how-la-la-land-resurrected-the-hollywood-musical-w454198";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "David Fear");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-09T14:50:00.000Z");
    });
