...
describe("WwwCbssportsComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.cbssports.com/mlb/news/why-despite-the-complaints-of-many-mlb-players-are-actually-not-overpaid/";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Matt Snyder");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-19T19:19:00.000Z");
    });
