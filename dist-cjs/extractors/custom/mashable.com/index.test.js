...
describe("MashableComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "https://mashable.com/article/mysterious-plane-flying-over-new-york";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Nicole Gallucci");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-13T22:33:06.000Z");
    });
