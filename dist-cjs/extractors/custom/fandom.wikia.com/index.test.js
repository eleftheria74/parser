...
describe("WikiaExtractor", () => {
  describe("initial test case", () => {
    ...
    it("returns the title", async () => {
      ...
      import_assert.default.equal(title, "Box Office: It\u2019s Good to Be \u2018Peculiar\u2019");
    });
    it("returns the author", async () => {
      const { author } = await result;
      import_assert.default.equal(author, "Drew Dietsch");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-10-03T02:30:57.000Z");
    });
