...
describe("WwwRecodeNetExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "http://www.recode.net/2016/12/15/13971502/fcc-tom-wheeler-departure-net-neutrality-death-trump-layton";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "April Glaser");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2016-12-15T18:55:10.000Z");
    });
    it("returns the dek", async () => {
      const { dek } = await result;
      import_assert.default.equal(dek, "The FCC will now have a Republican majority.");
    });
