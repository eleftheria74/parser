...
describe("WwwLadbibleComExtractor", () => {
  describe("initial test case", () => {
    ...
    let url;
    beforeAll(() => {
      url = "https://www.ladbible.com/news/latest-aussie-government-sparks-fury-over-graphic-and-confronting-covid-19-ad-20210711";
    ...
    it("returns the author", async () => {
      ...
      import_assert.default.equal(author, "Stewart Perrie");
    });
    it("returns the date_published", async () => {
      const { date_published } = await result;
      import_assert.default.equal(date_published, "2021-07-11T21:00:00.000Z");
    });
