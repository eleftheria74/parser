...
var import_extract_best_node = __toESM(require("./extract-best-node"));
const fs = require("fs");
describe("extractBestNode($, flags)", () => {
  it("scores the dom nodes and returns the best option", () => {
    ...
    const bestNode = (0, import_extract_best_node.default)($, {
      stripUnlikelyCandidates: true,
      weightNodes: true
    });
    (0, import_assert.default)(typeof bestNode, "object");
  });
});
